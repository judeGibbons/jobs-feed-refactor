...
//NOTE THAT DIVS IN HTML FILE MUST MATCH THESE!!!!!!!!
	...
	var addres = new catObject("addres", "Additional Research", [], "");
...
//END OF SECTION TO EDIT//
	...
	function rssfeedsetup() {
		...
		//var jobsfeed = new google.feeds.Feed(feedurl+"?t="+getTime());
		//var jobsfeed = new google.feeds.Feed(feedurl);
	...
	function displayfeed(result) {
				console.log(result); //result is defined here
				...
				if (newItemObject.category == ("Research")||newItemObject.category == ("Research Support")) { //add "Additional Research" if needed
					for (var l=0, maxl=frcsListArray.length; l<maxl; l++) {
						if (newItemObject.department == frcsListArray[l].namestring) {
							...
							if (newItemObject.category == ("Additional Research")) { //add "Additional Research" if needed
